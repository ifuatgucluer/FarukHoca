...
public class Q06_CountsOfRepeatingElement {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Aranilan sayiyi giriniz");
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            if (count>1){
                ...
                if (!stDizi.contains(","+st)) {
                    ...
                    stDizi = stDizi+st;
    //stDizinin icerisinde hepsini virgul ile ayirarak 1 ila icinde 1 gecen
    // daha buyuk bir sayinin karismasini engellemis olduk
                }
            }
